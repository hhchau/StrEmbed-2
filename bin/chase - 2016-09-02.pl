...
sub read_step_file {
    #my $file = "../2nd/data/step/puzzle_1b.STEP";
    #my $file = "../2nd/data/step/puzzle_1c.STEP";
    my $file = "../2nd/data/step/puzzle_1d.STEP";
    #my $file = "../mess with STEP files/puzzle_1c.STEP";
